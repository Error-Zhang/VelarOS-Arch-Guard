...
const preferIsPresentLooseNullish = defineCheck({
    ...
    description: '将任意 **`expr != null` / `expr == null`**（及与 **`null` / `undefined` 字面量的宽松比较**）改为 **`isPresent(expr)`** / **`!isPresent(expr)`**。',
    verifies: [
...
function isAlreadyIsPresentCall(expr) {
    const e = unwrapParen(expr);
...
//# sourceMappingURL=preferIsPresentLooseNullish.js.map