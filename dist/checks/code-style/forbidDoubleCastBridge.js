...
const forbidDoubleCastBridge = defineCheck({
    ...
    description: '禁止 `as unknown as X` / `as any as X` 双重断言跳板（§12.5）；外来数据在边界解析一次，信任区内信任类型系统。',
    verifies: [
...
function bridgeKeyword(typeNode) {
...
//# sourceMappingURL=forbidDoubleCastBridge.js.map