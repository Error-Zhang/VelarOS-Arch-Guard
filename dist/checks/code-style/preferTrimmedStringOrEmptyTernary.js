...
const preferTrimmedStringOrEmptyTernary = defineCheck({
    ...
    description: '将 isString(x) 或 typeof x === string（含 ==）与 x.trim() 及字面量 \'\' 的三元合并为 trimmedStringOrEmpty(x)（whenTrue 须为零参 .trim()）。',
    verifies: [
        '顶层三元：string 守卫 + trim + : \'\'。',
...
//# sourceMappingURL=preferTrimmedStringOrEmptyTernary.js.map