...
function readConsoleAccess(sourceFile, node) {
    ...
    if (ts.isElementAccessExpression(node) && ts.isIdentifier(node.expression) && node.expression.text === 'console')
        return `console[${node.argumentExpression.getText(sourceFile)}]`;
    return undefined;
}
export { forbidConsole };
//# sourceMappingURL=forbidConsole.js.map